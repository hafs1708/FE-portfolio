<template>
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="margin:auto;"
        ...
        <defs>
            <filter id="ldio-glce6ockdxa-filter" x="-100%" y="-100%" width="300%" height="300%"
        ...
        <g filter="url(#ldio-glce6ockdxa-filter)">
            ...
            <g transform="translate(50 50)">
                <g>
                    <circle cx="17" cy="0" r="5" fill="#f8b26a">
                        <animate attributeName="r" keyTimes="0;0.5;1"
                            values="3.5999999999999996;8.399999999999999;3.5999999999999996" dur="1.3333333333333333s"
