<template>
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
        style="margin:auto;background;display:block;" width="200px" height="200px" viewBox="0 0 100 100"
        preserveAspectRatio="xMidYMid">
        <defs>
            <path id="ldio-uo67b3ae11c-p1"
                ...
                <animateTransform attributeName="transform" type="translate" values="-3 0;3 0;-3 0" keyTimes="0;0.5;1"
                    dur="2" repeatCount="indefinite" calcMode="spline" keySplines="0.5 0 0.5 1;0.5 0 0.5 1">
                </animateTransform>
            </path>
            <path id="ldio-uo67b3ae11c-p2" d="M0 52L58 52L64 47L100 47L100 90L0 90Z"></path>
            <clipPath id="ldio-uo67b3ae11c-cp1">
                <use xlink:href="#ldio-uo67b3ae11c-p1"></use>
            </clipPath>
            <clipPath id="ldio-uo67b3ae11c-cp2">
                <use xlink:href="#ldio-uo67b3ae11c-p2"></use>
            </clipPath>
        </defs>
        <g clip-path="url(#ldio-uo67b3ae11c-cp2)">
            <path fill="#77a4bd"
                ...
                <animateTransform attributeName="transform" type="translate" values="15 -40;-30 80" keyTimes="0;1" dur="1"
            ...
            <path fill="#77a4bd"
                ...
                <animateTransform attributeName="transform" type="translate" values="15 -40;-30 80" keyTimes="0;1" dur="1"
                    repeatCount="indefinite" begin="-0.1s"></animateTransform>
            </path>
            <path fill="#77a4bd"
            ...
            <path fill="#77a4bd"
                ...
                <animateTransform attributeName="transform" type="translate" values="15 -40;-30 80" keyTimes="0;1" dur="1"
                    repeatCount="indefinite" begin="-0.30000000000000004s"></animateTransform>
            </path>
            <path fill="#77a4bd"
                ...
                <animateTransform attributeName="transform" type="translate" values="15 -40;-30 80" keyTimes="0;1" dur="1"
                    repeatCount="indefinite" begin="-0.4s"></animateTransform>
            </path>
            <path fill="#77a4bd"
            ...
            <path fill="#77a4bd"
                ...
                <animateTransform attributeName="transform" type="translate" values="15 -40;-30 80" keyTimes="0;1" dur="1"
                    repeatCount="indefinite" begin="-0.6000000000000001s"></animateTransform>
            </path>
            <path fill="#77a4bd"
                ...
                <animateTransform attributeName="transform" type="translate" values="15 -40;-30 80" keyTimes="0;1" dur="1"
                    repeatCount="indefinite" begin="-0.7000000000000001s"></animateTransform>
            </path>
            <path fill="#77a4bd"
                ...
                <animateTransform attributeName="transform" type="translate" values="15 -40;-30 80" keyTimes="0;1" dur="1"
                    repeatCount="indefinite" begin="-0.8s"></animateTransform>
            </path>
            <path fill="#77a4bd"
                ...
                <animateTransform attributeName="transform" type="translate" values="15 -40;-30 80" keyTimes="0;1" dur="1"
                    repeatCount="indefinite" begin="-0.9s"></animateTransform>
            </path>
            <path fill="#77a4bd"
                ...
                <animateTransform attributeName="transform" type="translate" values="15 -40;-30 80" keyTimes="0;1" dur="1"
                    repeatCount="indefinite" begin="-1s"></animateTransform>
            </path>
            <path fill="#77a4bd"
                d="M26.1 61.7l1.6-4.3c0.4-1.1-0.1-2.3-1.2-2.8c-1.1-0.4-2.3 0.1-2.8 1.2l-1.6 4.3 c-0.4 1.1 0.1 2.3 1.2 2.8c0.3 0.1 0.5 0.1 0.8 0.1C24.9 63.1 25.8 62.6 26.1 61.7z">
                <animateTransform attributeName="transform" type="translate" values="15 -40;-30 80" keyTimes="0;1" dur="1"
            ...
            <path fill="#77a4bd"
                d="M34.4 68.6l4.2-11.1c0.4-1.1-0.1-2.3-1.2-2.8c-1.1-0.4-2.3 0.1-2.8 1.2L30.4 67 c-0.4 1.1 0.1 2.3 1.2 2.8c0.2 0.1 0.5 0.1 0.8 0.1C33.3 70 34.1 69.4 34.4 68.6z">
                <animateTransform attributeName="transform" type="translate" values="15 -40;-30 80" keyTimes="0;1" dur="1"
                    repeatCount="indefinite" begin="-0.6s"></animateTransform>
            </path>
            <path fill="#77a4bd"
                d="M42.7 75.4l6.8-18c0.4-1.1-0.1-2.3-1.2-2.8c-1.1-0.4-2.3 0.1-2.8 1.2l-6.8 18 c-0.4 1.1 0.1 2.3 1.2 2.8c0.2 0.1 0.5 0.1 0.8 0.1C41.6 76.8 42.4 76.3 42.7 75.4z">
                <animateTransform attributeName="transform" type="translate" values="15 -40;-30 80" keyTimes="0;1" dur="1"
                    repeatCount="indefinite" begin="-0.7s"></animateTransform>
            </path>
            <path fill="#77a4bd"
                d="M58.3 63.1l2.1-5.5c0.4-1.1-0.1-2.3-1.2-2.8c-1.1-0.4-2.3 0.1-2.8 1.2l-2.1 5.5 c-0.4 1.1 0.1 2.3 1.2 2.8c0.3 0.1 0.5 0.1 0.8 0.1C57.1 64.5 57.9 63.9 58.3 63.1z">
                <animateTransform attributeName="transform" type="translate" values="15 -40;-30 80" keyTimes="0;1" dur="1"
            ...
            <path fill="#77a4bd"
                d="M16.9 86.4l6.4-17.3c0.4-1.1-0.2-2.3-1.3-2.8c-1.1-0.4-2.3 0.2-2.8 1.3l-6.4 17.3 c-0.4 1.1 0.2 2.3 1.3 2.8c0.2 0.1 0.5 0.1 0.7 0.1C15.7 87.8 16.6 87.2 16.9 86.4z">
                <animateTransform attributeName="transform" type="translate" values="15 -40;-30 80" keyTimes="0;1" dur="1"
                    repeatCount="indefinite" begin="-1.1s"></animateTransform>
            </path>
            <path fill="#77a4bd"
                d="M27.6 86.4l3.8-9.8c0.4-1.1-0.1-2.3-1.2-2.8c-1.1-0.4-2.3 0.1-2.8 1.2l-3.8 9.8 c-0.4 1.1 0.1 2.3 1.2 2.8c0.3 0.1 0.5 0.1 0.8 0.1C26.5 87.8 27.3 87.3 27.6 86.4z">
                <animateTransform attributeName="transform" type="translate" values="15 -40;-30 80" keyTimes="0;1" dur="1"
                    repeatCount="indefinite" begin="-1.2000000000000002s"></animateTransform>
            </path>
            <path fill="#77a4bd"
                d="M38.5 86.4l1-2.7c0.4-1.1-0.1-2.3-1.2-2.8c-1.1-0.4-2.3 0.1-2.8 1.2l-1 2.7 c-0.4 1.1 0.1 2.3 1.2 2.8c0.3 0.1 0.5 0.1 0.8 0.1C37.4 87.8 38.2 87.3 38.5 86.4z">
                <animateTransform attributeName="transform" type="translate" values="15 -40;-30 80" keyTimes="0;1" dur="1"
                    repeatCount="indefinite" begin="-1.3s"></animateTransform>
            </path>
            <path fill="#77a4bd"
                d="M49.3 86.4l5.9-15.2c0.4-1.1-0.1-2.3-1.2-2.8c-1.1-0.4-2.3 0.1-2.8 1.2l-5.9 15.2 c-0.4 1.1 0.1 2.3 1.2 2.8c0.3 0.1 0.5 0.1 0.8 0.1C48.1 87.8 48.9 87.3 49.3 86.4z">
                <animateTransform attributeName="transform" type="translate" values="15 -40;-30 80" keyTimes="0;1" dur="1"
                    repeatCount="indefinite" begin="-1.4s"></animateTransform>
            </path>
            <path fill="#77a4bd"
                d="M72.2 81.9l2.9-7.7c0.4-1.1-0.1-2.3-1.2-2.8c-1.1-0.4-2.3 0.1-2.8 1.2l-2.9 7.7 c-0.4 1.1 0.1 2.3 1.2 2.8c0.3 0.1 0.5 0.1 0.8 0.1C71.1 83.3 71.9 82.8 72.2 81.9z">
                <animateTransform attributeName="transform" type="translate" values="15 -40;-30 80" keyTimes="0;1" dur="1"
                    repeatCount="indefinite" begin="-1.5s"></animateTransform>
            </path>
        </g>
        <path fill="#999999"
            ...
            <animateTransform attributeName="transform" type="translate" values="-3 0;3 0;-3 0" keyTimes="0;0.5;1" dur="2"
                repeatCount="indefinite" calcMode="spline" keySplines="0.5 0 0.5 1;0.5 0 0.5 1"></animateTransform>
        </path>
        <g clip-path="url(#ldio-uo67b3ae11c-cp1)">
            <path fill="#bbbbbb"
                ...
                <animateTransform attributeName="transform" type="translate" values="-3 0;3 0;-3 0" keyTimes="0;0.5;1"
                    dur="1.32" repeatCount="indefinite" calcMode="spline" keySplines="0.5 0 0.5 1;0.5 0 0.5 1">
                </animateTransform>
            </path>
        </g>
    </svg>
